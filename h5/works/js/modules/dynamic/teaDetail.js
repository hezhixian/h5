...
define(function (require) {
    ...
    var vm = avalon.define({
        ...
        clickTool:function () {
            ...
            $(".weui-actions_mask").bind('click',function(){ $(".weui-actionsheet_cancel").click(); });
        },
        ...
        addReview:function (code) {
            window.location.href='/html/homework/review.html?code='+code+'&type=add&dynCode='+vm.curDynamicCode;
        },
        editReview:function (code) {
            window.location.href = '/html/homework/review.html?code=' +code + '&type=edit&dynCode='+vm.curDynamicCode;
        },
        utf161:function (str) {
